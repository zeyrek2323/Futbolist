                            ...
                            for oyuncu in oyuncular_listesi:
                                ...
                                if oyuncu_link:
                                    ...
                                    if oyuncu_soup:  # oyuncu_soup kontrolü yapılıyor
                                        ...
                                        # Initialize the goalkeeper scouting data list
                                        ...
                                        if oyuncu_bilgileri:
                                            try:
                                                ...
                                                resim_konteyner = oyuncu_soup.find("div", class_="media-item")
                                                
                                                oyuncu_resim = None
                                                if resim_konteyner:
                                                    img_tag = resim_konteyner.find("img")
                                                    if img_tag and "src" in img_tag.attrs:
                                                        oyuncu_resim = img_tag["src"]
